...
public class readyclass
{
    ...
    public string generateOTP()
    {
        ...
        string str = numIterations.ToString();
    ...
    public void sendSMS(string msg, string mobile)
    {
        try
        {
            HttpWebRequest myReq = (HttpWebRequest)WebRequest.Create("http://s.exonics.co.in/api/sendmsg.php?user=chetanpuc&pass=chetan123456&sender=CHETAN&phone= " + mobile + "&text=" + msg + "&priority=ndnd&stype=normal");
