...
public class ProfileActivity extends NavigationDrawerBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (conn == null) {
                ...
                String query1 = "Select * from tblEntrepreneur where Mobile='" + user_id + "'";
            ...
            public void onClick(View view)
            {
                ...
                try {
                    ...
                    if (conn == null) {
                        ...
                        String query2 = "Update tblEntrepreneur set Entrepreneur='" + etEntrepreneur.getText().toString() + "'," +
    ...
    private boolean setValidation() {
        ...
        if (username.isEmpty()) {
            etEntrepreneur.setError("Farmer Name can't be empty");
            isUserName = false;
        } else {
